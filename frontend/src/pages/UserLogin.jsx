...
const UserLogin = () => {
  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between'>
      ...
      <div>
        <Link to="/captain-login" className='bg-[#10b461] flex items-center justify-center text-white font-semibold mb-8 rounded px-4 py-2 w-full text-lg placeholder:text-base'>Sign in as Captain</Link>
      </div>
    </div>
  )
}
