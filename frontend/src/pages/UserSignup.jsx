...
const UserSignup = () => {
  ...
  const submitHandler=async(e)=>{
    ...
    try {
      ...
      console.error('Error:', error.response.data); // Log detailed error from the server
    }
    ...
    <div className='p-7 h-screen flex flex-col justify-between'>
      <div>
        ...
        <form onSubmit={(e)=>{
          ...
          <button className='bg-[#111] text-white font-semibold mb-3 rounded px-4 py-2 w-full text-lg placeholder:text-lg'>Create Account</button>
